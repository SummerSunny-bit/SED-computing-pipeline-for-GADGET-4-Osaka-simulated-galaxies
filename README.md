...
The repository further includes supporting documentation and manuels, including "GADGET-4 Osaka Manuel" and the author's own documentation, "Technical Documentation", 
